...
print("=========================================")
print("🎨 SyllabuswithRohit - V46 PURE CANVAS")
print("=========================================")
...
subprocess.run(["git", "commit", "-m", "V46 Pure Canvas: Removed Search, Backup, Restore. Kept power controls."], check=True)
subprocess.run(["git", "push"], check=True)
print("🌟 PURE CANVAS EDITION LIVE! Admin clutter is gone. Reading is front and center.")

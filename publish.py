        ...
        (function() {{
            ...
            window.toggleAudio = function() {{
                if(!window.audioCtx) {{
                    ...
                    let brownNoise = window.audioCtx.createBufferSource(); brownNoise.buffer = noiseBuffer; brownNoise.loop = true;
                    let noiseNode = window.audioCtx.createGain(); noiseNode.gain.value = 0.1;
                    brownNoise.connect(noiseNode); noiseNode.connect(window.audioCtx.destination); brownNoise.start(0);
                }}
